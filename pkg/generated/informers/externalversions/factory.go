...
import (
	...
	kcrd "github.com/jijiechen/external-crd/pkg/generated/informers/externalversions/kcrd"
...
func (f *sharedInformerFactory) Kcrd() kcrd.Interface {
	return kcrd.New(f, f.namespace, f.tweakListOptions)
}
