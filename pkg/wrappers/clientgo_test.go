...
func TestNormalizeLocation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces",
		},
		{
			name:          "apiv1 - get namespace abc",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/api/v1/namespaces/abc",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc",
		},
		{
			name:          "apiv1 - watch namespaces",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/api/v1/namespaces?resourceVersion=17825795&watch=true",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces?resourceVersion=17825795&watch=true",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc?fieldSelector=metadata.name%3Dabc&resourceVersion=0&watch=true",
		},

		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/serviceaccounts",
		},
		{
			name:          "apiv1 - get serviceaccounts abc",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/api/v1/namespaces/abc/serviceaccounts/abc",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/serviceaccounts/abc",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/serviceaccounts?resourceVersion=17825795&watch=true",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/abc/serviceaccounts/abc?fieldSelector=metadata.name%3Dabc&resourceVersion=0&watch=true",
		},

		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/foos",
		},
		{
			name:          "apis - get namespace-scoped foos abc",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/apis/far/v1bar/namespaces/abc/foos/abc",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/foos/abc",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/foos?resourceVersion=17825795&watch=true",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/abc/foos/abc?fieldSelector=metadata.name%3Dabc&resourceVersion=0&watch=true",
		},

		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/foos",
		},
		{
			name:          "apis - get cluster-scoped foos abc",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/apis/far/v1bar/foos/abc",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/foos/abc",
		},
		{
			name:          "apis - watch cluster-scoped foos",
			host:          "https://my.k8s.io",
			requestURL:    "https://my.k8s.io/apis/far/v1bar1/foos?resourceVersion=17825795&watch=true",
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/foos?resourceVersion=17825795&watch=true",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/foos/abc?fieldSelector=metadata.name%3Dabc&resourceVersion=0&watch=true",
		},
		...
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/default/foos",
		},
		{
			...
			normalizedURL: "https://my.k8s.io/apis/overlay/v1alpha1/namespaces/default/foos?fieldSelector=metadata.name%3Dabc&resourceVersion=0&watch=true",
		},
		...
		},
		{
			...
			normalizedURL: "https://my.k8s.io/abc/apis/overlay/v1alpha1/foos/abc",
		},
		{
		...
		},
		{
			...
			normalizedURL: "https://my.k8s.io/abc/apis/overlay/v1alpha1/foos",
		},
		{
		...
		},
		{
			...
			normalizedURL: "https://my.k8s.io/abc/apis/overlay/v1alpha1/foos/abc/def",
		},
		{
